					...
					<div class="col mx-auto">
						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center">
										<h3 class="">Sign in</h3>
										<p>Don't have an account yet? <a href="backend/authentication-signup.html">Sign up here</a>
										</p>
									</div>
									<div class="d-grid">
                          ...
                          <span>Sign in with Google</span>
										...
										</a> <a href="backend/javascript:;" class="btn btn-facebook"><i class="bx bxl-facebook"></i>Sign in with Facebook</a>
									</div>
									...
									<div class="form-body">
										<form class="row g-3" action="{{ route('login')}}" method="POST">
											...
											<div class="col-md-6 text-end">	<a href="backend/authentication-forgot-password.html">Forgot Password ?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
